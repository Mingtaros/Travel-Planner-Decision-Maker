...
data/alns_inputs (got two json file to prep)
> POI_data_XX.json

key: Hawker/Attraction:
...
> moo_parameters_XX.json
 ...
 -List[w1, w2, w3] -  Parameters for Multi-Objective Function Weights [weight_cost, weight_traveltime, weight_satisfaction]
